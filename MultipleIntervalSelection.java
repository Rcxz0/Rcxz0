...
/**
 * This class demonstrates the List Component in multiple interval selection
 * mode.
 */
public class MultipleIntervalSelection extends JFrame {
    ...
    /**
     * The buildSelectedMonthsPanel method adds a list to a panel. This will
     * hold the selected months.
     */
    ...
    private void buildButtonPanel() {
        ...
        button.setToolTipText("Press to Get Selected");
...
//                        monthList.getSelectedValues();
            ...
            java.util.List<String> selections = monthList.getSelectedValuesList();

            // Store the selected items in selectedMonthList.
            selectedMonthList.setListData(selections.toArray());
        }
    }
